-- Persist family assets and bank accounts per user in public schema.
-- FamilyHub frontend reads/writes these via Supabase REST: /rest/v1/assets and /rest/v1/bank_accounts.
...
create table if not exists public.assets (
  ...
  current_value numeric generated always as (value) stored,
