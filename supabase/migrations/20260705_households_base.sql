...
-- RIKTIG REKKEFØLGE: begge tabeller opprettes først, deretter policyer

-- 1. OPPRETT households
...
-- 3. AKTIVER RLS på begge (må skje før policyer)
alter table public.households enable row level security;
alter table public.household_members enable row level security;

-- 4. POLICYER på household_members
...
-- 5. POLICYER på households (nå kan de referere til household_members)
